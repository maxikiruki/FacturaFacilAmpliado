...
class __TwigTemplate_8e7637743fb32e12b75af15f0f763c0c46c712142eb019401278886c66186af5 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
var datemonth=document.getElementById('invoice_date_month');
\tdatemonth.disabled = true;;

\tvar dateday=document.getElementById('invoice_date_day');
\tdateday.disabled = true;

\tvar dateyear=document.getElementById('invoice_date_year');
...
\t</script>
{% endblock %}
", "invoice/toPrint.html.twig", "D:\\GS_DAW\\SEGUNDO\\Proyecto Grupal\\invoice develop\\templates\\invoice\\toPrint.html.twig");
    }
}
