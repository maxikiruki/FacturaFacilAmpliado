...
class __TwigTemplate_47471e6ae74f1a34786c39cd7bcc41e791eab355f340ec4fd2dfdb0bc954be40 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["social_networks"]) || array_key_exists("social_networks", $context) ? $context["social_networks"] : (function () { throw new RuntimeError('Variable "social_networks" does not exist.', 20, $this->source); })()));
...
\t\t\t\t\t<td>";
            // line 22
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["social_network"], "url", [], "any", false, false, false, 22), "html", null, true);
            echo "</td>
\t\t\t\t\t<td>
\t\t\t\t\t\t<a href=\"";
            // line 24
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("social_network_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["social_network"], "id", [], "any", false, false, false, 24)]), "html", null, true);
            echo "\">Editar</a>
\t\t\t\t\t</td>
\t\t\t\t</tr>
\t\t\t";
...
";
    ...
    {
        return array (  157 => 35,  152 => 32,  143 => 28,  134 => 24,  129 => 22,  126 => 21,  121 => 20,  110 => 11,  100 => 10,  90 => 6,  80 => 5,  60 => 3,  37 => 1,);
    }
...
{% endblock %}
", "social_network/index.html.twig", "D:\\Users\\ruben\\Escritorio\\Trabajos\\DWES\\2EV\\invoice\\templates\\social_network\\index.html.twig");
    }
}
