...
class __TwigTemplate_268713e923b90d4e1aceaf49247e96bf3f2e1280a5cf69b7ec7a5d0d850b4f3f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Creaci&oacute;n de nuevo cliente
";
...
\t\t<h1>Creaci&oacute;n de nuevo cliente</h1>
...
\t\t<a href=\"";
        // line 24
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("client_index", ["idempresa" => (isset($context["id_empresa"]) || array_key_exists("id_empresa", $context) ? $context["id_empresa"] : (function () { throw new RuntimeError('Variable "id_empresa" does not exist.', 24, $this->source); })())]), "html", null, true);
...
";
    ...
    {
        return array (  150 => 24,  145 => 22,  138 => 17,  128 => 16,  116 => 13,  106 => 12,  86 => 9,  74 => 5,  71 => 4,  61 => 3,  38 => 1,);
    }
...
{% block title %}Creaci&oacute;n de nuevo cliente
{% endblock %}
...
\t\t<a href=\"{{ path('client_index', {'idempresa': id_empresa }) }}\">Volver al listado</a>

\t</div>
{% endblock %}
", "client/new.html.twig", "D:\\GS_DAW\\SEGUNDO\\Proyecto Grupal\\invoice develop\\templates\\client\\new.html.twig");
    }
}
