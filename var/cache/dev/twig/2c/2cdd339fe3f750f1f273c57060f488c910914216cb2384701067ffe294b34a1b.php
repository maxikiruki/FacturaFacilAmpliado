...
class __TwigTemplate_9b6987e390aa4bb29fdea05f33ad2f93fdace4d86ac6e40fca4dfea30a0b0fb0 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        // line 19
        $this->loadTemplate("budget/basebudget.html.twig", "budget/new.html.twig", 19)->display($context);
        echo "    
...
";
    ...
    <script src=\"";
        // line 31
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("js/budget.js"), "html", null, true);
        echo "\"></script>   
    ";
        // line 33
        echo "    <script>
...
";
    ...
    {
        return array (  212 => 47,  209 => 44,  197 => 33,  193 => 31,  188 => 30,  178 => 29,  167 => 26,  162 => 23,  158 => 22,  154 => 21,  149 => 19,  143 => 16,  131 => 15,  119 => 12,  109 => 11,  90 => 9,  77 => 5,  72 => 4,  62 => 3,  39 => 1,);
    }
...
{% block body %}  
    ...
    {% include \"budget/basebudget.html.twig\" %}    
...
{% block javascripts %}
    ...
    {# SETEO LOS CAMPOS FINALES EN READONLY #}
    <script>
    var inputSubtotal= document.getElementById('budget_subtotal');
    inputSubtotal.readOnly = true;
...
{% endblock %}", "budget/new.html.twig", "D:\\GS_DAW\\SEGUNDO\\Proyecto Grupal\\invoice develop\\templates\\budget\\new.html.twig");
    }
}
