...
class Product extends \App\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'price', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'vat', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'description', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'enterprise'];
        }
     ...
     * {@inheritDoc}
     */
    public function setVat(float $vat): \App\Entity\Product
    {
     ...
     * {@inheritDoc}
     */
    public function setEnterprise(?\App\Entity\Enterprise $enterprise): \App\Entity\Product
    {
